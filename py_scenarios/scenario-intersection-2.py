...
class Scenario(PyScenario):
    def get_description(self):
        return 'Force a car to enter an intersection aggressively, just when another car is about to reach it (using a kinematics solver)'
    ...
    def solver_should_start(self, dt):
        ...
        eta_B = self.car_2.dynamics.solve_eta_on_curve_ex(car_2_loc.curve, car_2_loc.t, 1.0, self.car_2_target_speed)
